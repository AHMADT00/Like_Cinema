...
declare type PromiseReturningFunctionPropertyNames<T> = {
    [K in FunctionPropertyNames<T>]: ReturnType<any> extends Promise<any> ? K : never;
}[FunctionPropertyNames<T>];
declare type NonPromiseReturningFunctionPropertyNames<T> = {
    [K in FunctionPropertyNames<T>]: ReturnType<any> extends Promise<any> ? never : K;
}[FunctionPropertyNames<T>];
...
export declare type ɵPromiseProxy<T> = {
    ...
    [K in NonPromiseReturningFunctionPropertyNames<T>]: (...args: Parameters<any>) => Promise<ReturnType<any>>;
} & {
    [K in PromiseReturningFunctionPropertyNames<T>]: (...args: Parameters<any>) => ReturnType<any>;
};
